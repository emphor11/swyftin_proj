...
class Settings:
    ...
    llama_max_tokens: int = int(os.getenv("VCA_LLAMA_MAX_TOKENS", "900"))
    llama_timeout_seconds: int = int(os.getenv("VCA_LLAMA_TIMEOUT_SECONDS", "90"))
    pyannote_timeout_seconds: int = int(os.getenv("VCA_PYANNOTE_TIMEOUT_SECONDS", "150"))
